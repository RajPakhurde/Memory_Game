...
import com.rajpakhurde.memorygame.utils.BitmapScaler
import com.rajpakhurde.memorygame.utils.EXTRA_BOARD_SIZE
import com.rajpakhurde.memorygame.utils.isPermissionGranted
import com.rajpakhurde.memorygame.utils.requestPermission
...
class CreateActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        private const val PICK_PHOTO_CODE = 223
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = ImagePickerAdapter(
            ...
            object : ImagePickerAdapter.ImageClickListener {
                override fun onPlaceholderCliked() {
    ...
    override fun onRequestPermissionsResult(
        ...
        if (requestCode == READ_EXTERNAL_PHOTOS_CODE) {
            if (grantResults.isNotEmpty() && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(
                    this,
                    "In order to create your own custom game, you need to provide access to your photos",
                    Toast.LENGTH_LONG
                ).show()
            }
        }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode != PICK_PHOTO_CODE && resultCode != Activity.RESULT_OK && data == null) {
            Log.i(
                TAG,
                "Did not get data bac from the launched acitivity, user likely canceled flow"
            )
            return
        }
